...
public class People {
    ...
    public static final Emojicon[] DATA = new Emojicon[] {Emojicon.fromCodePoint(0x1f604),
            ...
            Emojicon.fromCodePoint(0x1f44a), Emojicon.fromChar((char) 0x270a), Emojicon.fromChar(
            (char) 0x270c), Emojicon.fromCodePoint(0x1f44b), Emojicon.fromChar((char) 0x270b),
