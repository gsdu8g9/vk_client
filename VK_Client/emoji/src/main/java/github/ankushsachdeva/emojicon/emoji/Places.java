...
public class Places {
    ...
    public static final Emojicon[] DATA = new Emojicon[] {Emojicon.fromCodePoint(0x1f3e0),
            ...
            Emojicon.fromChar((char) 0x2693), Emojicon.fromCodePoint(0x1f680), Emojicon.fromChar(
            (char) 0x2708), Emojicon.fromCodePoint(0x1f4ba), Emojicon.fromCodePoint(0x1f681),
